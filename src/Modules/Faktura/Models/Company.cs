...
using Kuestencode.Faktura.Models.CompanyConfiguration;
...
public class Company
{
    ...
    // Navigation Properties (New Structure)
    // These will eventually replace the inline properties above
    [NotMapped] // Temporarily not mapped until migration is complete
    public SmtpSettings? SmtpSettings { get; set; }

    [NotMapped]
    public PdfDesignSettings? PdfDesignSettings { get; set; }

    [NotMapped]
    public EmailDesignSettings? EmailDesignSettings { get; set; }
}
