...
public class ApiCompanyService : ICompanyService
{
    ...
    public Task<Company> UpdateCompanyAsync(Company company)
        => throw new NotSupportedException("Updating company data is not supported in microservice mode.");
