...
public class ApiCustomerService : ICustomerService
{
    ...
    public Task<Customer> CreateAsync(Customer customer)
        => throw new NotSupportedException("Creating customers is not supported in microservice mode.");

    public Task UpdateAsync(Customer customer)
        => throw new NotSupportedException("Updating customers is not supported in microservice mode.");

    public Task DeleteAsync(int id)
        => throw new NotSupportedException("Deleting customers is not supported in microservice mode.");

    public Task<string> GenerateCustomerNumberAsync()
        => throw new NotSupportedException("Generating customer numbers is not supported in microservice mode.");

    public Task<bool> CustomerNumberExistsAsync(string number)
        => throw new NotSupportedException("Checking customer numbers is not supported in microservice mode.");
