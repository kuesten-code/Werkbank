...
namespace Kuestencode.Werkbank.Recepta.Data.Migrations
{
    ...
    [Migration("20260517000001_AddSkontoAmountOverride")]
    partial class AddSkontoAmountOverride
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Kuestencode.Werkbank.Recepta.Domain.Entities.DocumentActivityLog", b =>
                {
                    ...
                    b.ToTable("DocumentActivityLogs", "recepta");
                });
            ...
            modelBuilder.Entity("Kuestencode.Werkbank.Recepta.Domain.Entities.Document", b =>
                {
                    ...
                    b.Property<decimal>("AmountNet19")
                        .HasPrecision(18, 2)
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("AmountNet7")
                        .HasPrecision(18, 2)
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("AmountNet0")
                        .HasPrecision(18, 2)
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.Property<decimal>("AmountTax19")
                        .HasPrecision(18, 2)
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("AmountTax7")
                        .HasPrecision(18, 2)
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.Property<bool>("SkontoApplied")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false);

                    b.Property<decimal?>("SkontoAmountOverride")
                        .HasPrecision(18, 2)
                        .HasColumnType("decimal(18,2)");

                    b.Property<int?>("SkontoDays")
                        .HasColumnType("integer");

                    b.Property<decimal?>("SkontoPercent")
                        .HasPrecision(5, 2)
            ...
            modelBuilder.Entity("Kuestencode.Werkbank.Recepta.Domain.Entities.DocumentPayment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("DocumentPayments", "recepta");
                });
