...
-- Kunden
INSERT INTO host."Customers" ("CustomerNumber", "Name", "Address", "PostalCode", "City", "Country", "Email", "Phone", "Notes", "CreatedAt", "UpdatedAt") VALUES
...
INSERT INTO faktura."Invoices" (
    ...
    (SELECT "Id" FROM host."Customers" WHERE "CustomerNumber" = 'K-001'),
...
INSERT INTO faktura."Invoices" (
    ...
    (SELECT "Id" FROM host."Customers" WHERE "CustomerNumber" = 'K-003'),
...
INSERT INTO faktura."Invoices" (
    ...
    (SELECT "Id" FROM host."Customers" WHERE "CustomerNumber" = 'K-002'),
...
INSERT INTO faktura."Invoices" (
    ...
    (SELECT "Id" FROM host."Customers" WHERE "CustomerNumber" = 'K-007'),
...
INSERT INTO faktura."Invoices" (
    ...
    (SELECT "Id" FROM host."Customers" WHERE "CustomerNumber" = 'K-005'),
...
INSERT INTO faktura."Invoices" (
    ...
    (SELECT "Id" FROM host."Customers" WHERE "CustomerNumber" = 'K-006'),
...
INSERT INTO faktura."Invoices" (
    ...
    (SELECT "Id" FROM host."Customers" WHERE "CustomerNumber" = 'K-004'),
...
INSERT INTO faktura."Invoices" (
    ...
    (SELECT "Id" FROM host."Customers" WHERE "CustomerNumber" = 'K-008'),
...
INSERT INTO faktura."InvoiceItems" ("InvoiceId", "Position", "Description", "Quantity", "UnitPrice", "VatRate")
SELECT "Id", 1, 'IT-Wartung Pauschal (monatlich)', 1, 850.00, 19.00 FROM faktura."Invoices" WHERE "InvoiceNumber" = 'WIT-2024-001';
INSERT INTO faktura."InvoiceItems" ("InvoiceId", "Position", "Description", "Quantity", "UnitPrice", "VatRate")
SELECT "Id", 2, 'Remote-Support (Stunden)', 3.5, 95.00, 19.00 FROM faktura."Invoices" WHERE "InvoiceNumber" = 'WIT-2024-001';
INSERT INTO faktura."InvoiceItems" ("InvoiceId", "Position", "Description", "Quantity", "UnitPrice", "VatRate")
SELECT "Id", 3, 'Hardware: USB-C Docking Station', 2, 189.00, 19.00 FROM faktura."Invoices" WHERE "InvoiceNumber" = 'WIT-2024-001';

-- Rechnung 2: Arztpraxis
INSERT INTO faktura."InvoiceItems" ("InvoiceId", "Position", "Description", "Quantity", "UnitPrice", "VatRate")
SELECT "Id", 1, 'IT-Betreuung Arztpraxis (monatlich)', 1, 450.00, 19.00 FROM faktura."Invoices" WHERE "InvoiceNumber" = 'WIT-2024-002';
INSERT INTO faktura."InvoiceItems" ("InvoiceId", "Position", "Description", "Quantity", "UnitPrice", "VatRate")
SELECT "Id", 2, 'Backup-Service Cloud (monatlich)', 1, 79.00, 19.00 FROM faktura."Invoices" WHERE "InvoiceNumber" = 'WIT-2024-002';

-- Rechnung 3: Server-Migration (mit Rabatt)
INSERT INTO faktura."InvoiceItems" ("InvoiceId", "Position", "Description", "Quantity", "UnitPrice", "VatRate")
SELECT "Id", 1, 'Server-Migration (Planung & Durchführung)', 1, 2400.00, 19.00 FROM faktura."Invoices" WHERE "InvoiceNumber" = 'WIT-2024-003';
INSERT INTO faktura."InvoiceItems" ("InvoiceId", "Position", "Description", "Quantity", "UnitPrice", "VatRate")
SELECT "Id", 2, 'Netzwerk-Optimierung', 8, 95.00, 19.00 FROM faktura."Invoices" WHERE "InvoiceNumber" = 'WIT-2024-003';
INSERT INTO faktura."InvoiceItems" ("InvoiceId", "Position", "Description", "Quantity", "UnitPrice", "VatRate")
SELECT "Id", 3, 'Dokumentation & Schulung', 4, 85.00, 19.00 FROM faktura."Invoices" WHERE "InvoiceNumber" = 'WIT-2024-003';
INSERT INTO faktura."InvoiceItems" ("InvoiceId", "Position", "Description", "Quantity", "UnitPrice", "VatRate")
SELECT "Id", 4, 'Hardware: Server Dell PowerEdge T150', 1, 1850.00, 19.00 FROM faktura."Invoices" WHERE "InvoiceNumber" = 'WIT-2024-003';

-- Rechnung 4: Dezember Wartung
INSERT INTO faktura."InvoiceItems" ("InvoiceId", "Position", "Description", "Quantity", "UnitPrice", "VatRate")
SELECT "Id", 1, 'IT-Wartung Pauschal (monatlich)', 1, 850.00, 19.00 FROM faktura."Invoices" WHERE "InvoiceNumber" = 'WIT-2024-004';
INSERT INTO faktura."InvoiceItems" ("InvoiceId", "Position", "Description", "Quantity", "UnitPrice", "VatRate")
SELECT "Id", 2, 'Windows 11 Upgrade (5 Arbeitsplätze)', 5, 45.00, 19.00 FROM faktura."Invoices" WHERE "InvoiceNumber" = 'WIT-2024-004';

-- Rechnung 5: Überfällig - Autohaus
INSERT INTO faktura."InvoiceItems" ("InvoiceId", "Position", "Description", "Quantity", "UnitPrice", "VatRate")
SELECT "Id", 1, 'Werkstattsoftware-Update auf Version 5.0', 1, 590.00, 19.00 FROM faktura."Invoices" WHERE "InvoiceNumber" = 'WIT-2024-005';
INSERT INTO faktura."InvoiceItems" ("InvoiceId", "Position", "Description", "Quantity", "UnitPrice", "VatRate")
SELECT "Id", 2, 'Mitarbeiterschulung (vor Ort)', 4, 120.00, 19.00 FROM faktura."Invoices" WHERE "InvoiceNumber" = 'WIT-2024-005';
INSERT INTO faktura."InvoiceItems" ("InvoiceId", "Position", "Description", "Quantity", "UnitPrice", "VatRate")
SELECT "Id", 3, 'Anfahrtspauschale', 1, 45.00, 19.00 FROM faktura."Invoices" WHERE "InvoiceNumber" = 'WIT-2024-005';

-- Rechnung 6: Entwurf - Gasthaus (mit 10% Rabatt)
INSERT INTO faktura."InvoiceItems" ("InvoiceId", "Position", "Description", "Quantity", "UnitPrice", "VatRate")
SELECT "Id", 1, 'Website-Relaunch (Design & Entwicklung)', 1, 2800.00, 19.00 FROM faktura."Invoices" WHERE "InvoiceNumber" = 'WIT-2024-006';
INSERT INTO faktura."InvoiceItems" ("InvoiceId", "Position", "Description", "Quantity", "UnitPrice", "VatRate")
SELECT "Id", 2, 'Kassensystem-Integration', 1, 450.00, 19.00 FROM faktura."Invoices" WHERE "InvoiceNumber" = 'WIT-2024-006';
INSERT INTO faktura."InvoiceItems" ("InvoiceId", "Position", "Description", "Quantity", "UnitPrice", "VatRate")
SELECT "Id", 3, 'Online-Reservierungssystem', 1, 380.00, 19.00 FROM faktura."Invoices" WHERE "InvoiceNumber" = 'WIT-2024-006';
INSERT INTO faktura."InvoiceItems" ("InvoiceId", "Position", "Description", "Quantity", "UnitPrice", "VatRate")
SELECT "Id", 4, 'SEO-Grundoptimierung', 1, 290.00, 19.00 FROM faktura."Invoices" WHERE "InvoiceNumber" = 'WIT-2024-006';

-- Rechnung 7: Steuerberater Datev
INSERT INTO faktura."InvoiceItems" ("InvoiceId", "Position", "Description", "Quantity", "UnitPrice", "VatRate")
SELECT "Id", 1, 'Datev-Schnittstelle Einrichtung', 1, 680.00, 19.00 FROM faktura."Invoices" WHERE "InvoiceNumber" = 'WIT-2024-007';
INSERT INTO faktura."InvoiceItems" ("InvoiceId", "Position", "Description", "Quantity", "UnitPrice", "VatRate")
SELECT "Id", 2, 'Konfiguration & Test', 3, 95.00, 19.00 FROM faktura."Invoices" WHERE "InvoiceNumber" = 'WIT-2024-007';
INSERT INTO faktura."InvoiceItems" ("InvoiceId", "Position", "Description", "Quantity", "UnitPrice", "VatRate")
SELECT "Id", 3, 'Dokumentation', 1, 150.00, 19.00 FROM faktura."Invoices" WHERE "InvoiceNumber" = 'WIT-2024-007';

-- Rechnung 8: Storniert
INSERT INTO faktura."InvoiceItems" ("InvoiceId", "Position", "Description", "Quantity", "UnitPrice", "VatRate")
SELECT "Id", 1, 'Elektroinstallation IT-Verkabelung', 1, 1200.00, 19.00 FROM faktura."Invoices" WHERE "InvoiceNumber" = 'WIT-2024-008';

-- Rechnung 9: Bäckerei mit Anzahlung
INSERT INTO faktura."InvoiceItems" ("InvoiceId", "Position", "Description", "Quantity", "UnitPrice", "VatRate")
SELECT "Id", 1, 'Filialsystem-Erweiterung (3. Standort)', 1, 1800.00, 19.00 FROM faktura."Invoices" WHERE "InvoiceNumber" = 'WIT-2024-009';
INSERT INTO faktura."InvoiceItems" ("InvoiceId", "Position", "Description", "Quantity", "UnitPrice", "VatRate")
SELECT "Id", 2, 'Hardware: Kassen-Terminal', 1, 890.00, 19.00 FROM faktura."Invoices" WHERE "InvoiceNumber" = 'WIT-2024-009';
INSERT INTO faktura."InvoiceItems" ("InvoiceId", "Position", "Description", "Quantity", "UnitPrice", "VatRate")
SELECT "Id", 3, 'Installation & Einrichtung vor Ort', 6, 95.00, 19.00 FROM faktura."Invoices" WHERE "InvoiceNumber" = 'WIT-2024-009';
INSERT INTO faktura."InvoiceItems" ("InvoiceId", "Position", "Description", "Quantity", "UnitPrice", "VatRate")
SELECT "Id", 4, 'Mitarbeiterschulung', 2, 120.00, 19.00 FROM faktura."Invoices" WHERE "InvoiceNumber" = 'WIT-2024-009';

-- Rechnung 10: Entwurf Arztpraxis Dezember
INSERT INTO faktura."InvoiceItems" ("InvoiceId", "Position", "Description", "Quantity", "UnitPrice", "VatRate")
SELECT "Id", 1, 'IT-Betreuung Arztpraxis (monatlich)', 1, 450.00, 19.00 FROM faktura."Invoices" WHERE "InvoiceNumber" = 'WIT-2024-010';
INSERT INTO faktura."InvoiceItems" ("InvoiceId", "Position", "Description", "Quantity", "UnitPrice", "VatRate")
SELECT "Id", 2, 'Backup-Service Cloud (monatlich)', 1, 79.00, 19.00 FROM faktura."Invoices" WHERE "InvoiceNumber" = 'WIT-2024-010';
INSERT INTO faktura."InvoiceItems" ("InvoiceId", "Position", "Description", "Quantity", "UnitPrice", "VatRate")
SELECT "Id", 3, 'Praxissoftware-Update', 1, 180.00, 19.00 FROM faktura."Invoices" WHERE "InvoiceNumber" = 'WIT-2024-010';

-- Anzahlungen für Rechnung 9
INSERT INTO faktura."DownPayments" ("InvoiceId", "Description", "Amount", "PaymentDate", "CreatedAt")
SELECT "Id", 'Anzahlung bei Auftragserteilung', 1000.00, '2024-11-10', NOW() FROM faktura."Invoices" WHERE "InvoiceNumber" = 'WIT-2024-009';
...
(gen_random_uuid(), '2024-11-25 08:30:00', '2024-11-25 10:45:00', 'Server-Monitoring und Backup-Prüfung', false,
    (SELECT "Id" FROM host."Customers" WHERE "CustomerNumber" = 'K-001'), 'Müller & Söhne GmbH', NULL, NULL, 1, false, NULL, NOW(), NOW()),
...
(gen_random_uuid(), '2024-11-26 13:00:00', '2024-11-26 17:30:00', 'Server-Migration Phase 1: Datensicherung', false,
    (SELECT "Id" FROM host."Customers" WHERE "CustomerNumber" = 'K-002'), 'Schmidt Maschinenbau AG', NULL, NULL, 1, false, NULL, NOW(), NOW()),
...
(gen_random_uuid(), '2024-12-02 08:00:00', '2024-12-02 09:30:00', 'Praxissoftware-Update und Test', false,
    (SELECT "Id" FROM host."Customers" WHERE "CustomerNumber" = 'K-003'), 'Dr. Anna Becker', NULL, NULL, 1, false, NULL, NOW(), NOW()),
...
(gen_random_uuid(), '2024-12-03 09:00:00', '2024-12-03 12:30:00', 'Datev-Schnittstelle Einrichtung', false,
    (SELECT "Id" FROM host."Customers" WHERE "CustomerNumber" = 'K-006'), 'Fischer Steuerberatung', NULL, NULL, 1, false, NULL, NOW(), NOW()),
...
(gen_random_uuid(), '2024-12-05 07:00:00', '2024-12-05 12:00:00', 'Kassensystem-Installation Filiale 3', false,
    (SELECT "Id" FROM host."Customers" WHERE "CustomerNumber" = 'K-008'), 'Bäckerei Tradition Huber', NULL, NULL, 1, false, NULL, NOW(), NOW()),
...
(gen_random_uuid(), '2024-12-09 09:00:00', '2024-12-09 12:00:00', 'Werkstattsoftware-Update auf v5.0', false,
    (SELECT "Id" FROM host."Customers" WHERE "CustomerNumber" = 'K-007'), 'Autohaus Brenner', NULL, NULL, 1, false, NULL, NOW(), NOW()),
...
(gen_random_uuid(), '2024-12-11 09:00:00', '2024-12-11 12:00:00', 'Website-Relaunch: Konzeptbesprechung', false,
    (SELECT "Id" FROM host."Customers" WHERE "CustomerNumber" = 'K-005'), 'Gasthaus Zum Goldenen Hirsch', NULL, NULL, 1, false, NULL, NOW(), NOW()),
...
(gen_random_uuid(), '2024-12-06 14:00:00', '2024-12-06 15:30:00', 'Telefonische Beratung und Remote-Support', true,
    (SELECT "Id" FROM host."Customers" WHERE "CustomerNumber" = 'K-003'), 'Dr. Anna Becker', NULL, NULL, 2, false, NULL, NOW(), NOW()),
(gen_random_uuid(), '2024-12-11 14:00:00', '2024-12-11 15:00:00', 'Telefonische Supportanfrage', true,
    (SELECT "Id" FROM host."Customers" WHERE "CustomerNumber" = 'K-002'), 'Schmidt Maschinenbau AG', NULL, NULL, 2, false, NULL, NOW(), NOW());
